...
test('renders CurrencyOption component', () => {
  render(<CurrencyOption currency={mockCurrency} handleCurrencyChange={jest.fn()} />);
...
test('calls handleCurrencyChange on click', () => {
  ...
  render(<CurrencyOption currency={mockCurrency} handleCurrencyChange={handleCurrencyChange} />);
  const currencyElement = screen.getByText(/USD/i);
